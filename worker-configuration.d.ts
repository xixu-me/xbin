/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 66ec2d07ecff4cba477f98430a977e7f)
// Runtime types generated with workerd@1.20260409.1 2026-03-19 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PasteCoordinator";
	}
	interface Env {
		PASTES_BUCKET: R2Bucket;
		DB: D1Database;
		GC_QUEUE: Queue;
		ASSETS: Fetcher;
		XBIN_APP_NAME: "Xbin";
		XBIN_APP_VERSION: "1.0.0";
		XBIN_PROJECT_PAGE_URL: "https://github.com/xixu-me/xbin";
		XBIN_BASE_PATH: "/";
		XBIN_MAX_PASTE_BYTES: "10000000";
		XBIN_DEFAULT_EXPIRATION: "1hour";
		XBIN_SUPPORTED_EXPIRATIONS: "5min,10min,30min,1hour,3hour,6hour,12hour,1day,3day,1week";
		XBIN_ENABLE_LEGACY_API: "true";
		XBIN_REQUIRE_TURNSTILE: "false";
		XBIN_BURN_CLAIM_TTL_SECONDS: "120";
		PASTE_COORDINATOR: DurableObjectNamespace<import("./src/index").PasteCoordinator>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "XBIN_APP_NAME" | "XBIN_APP_VERSION" | "XBIN_PROJECT_PAGE_URL" | "XBIN_BASE_PATH" | "XBIN_MAX_PASTE_BYTES" | "XBIN_DEFAULT_EXPIRATION" | "XBIN_SUPPORTED_EXPIRATIONS" | "XBIN_ENABLE_LEGACY_API" | "XBIN_REQUIRE_TURNSTILE" | "XBIN_BURN_CLAIM_TTL_SECONDS">> {}
}
